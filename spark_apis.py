...
def add_room_membership(room_id, email_invite):
    ...
    # invite membership to the {room_id}
...
def post_room_message(room_id, message):
    ...
    # post message to the Spark room with the {room_id}
...
def last_user_message(room_id):
    ...
    # retrieve the last message from the room with the {room_id}
