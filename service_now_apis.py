...
def get_last_incidents_list(incident_count):
    """
    This function will return the incident numbers for the last number of incidents {incident_count}
...
def get_last_incidents_info(incident_count):
    """
    This function will return the info for the last number of incidents {incident_count}
    :param incident_count: number of incidents
